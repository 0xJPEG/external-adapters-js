...
| Required? |   Name   |     Description     |  Type  |                             Options                              |  Default  |
| :-------: | :------: | :-----------------: | :----: | :--------------------------------------------------------------: | :-------: |
|           | endpoint | The endpoint to use | string | [tickers](#tickers-endpoint), [conversion](#conversion-endpoint) | `tickers` |

---

## Tickers Endpoint

Supported names for this endpoint are: `tickers`, `forex`, `price`.
